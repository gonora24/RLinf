...
#SBATCH --job-name=metaworld_50_dsrl_openpi
...
export NUM_CPUS="${SLURM_JOB_CPUS_PER_NODE}"
printf "NUM_CPUS: %s\n" "$NUM_CPUS"
...
bash examples/embodiment/run_embodiment.sh metaworld_50_dsrl_openpi #libero_object_dsrl_openpi_pi05 #metaworld_50_dsrl_openpi_q_chk_consistency