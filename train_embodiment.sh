...
#SBATCH --job-name=actorT_qchk_metaworld_50_dsrl_openpi
...
bash examples/embodiment/run_embodiment.sh metaworld_50_dsrl_openpi_q_chk_actorT #libero_object_dsrl_openpi_pi05 #metaworld_50_dsrl_openpi_q_chk_consistency