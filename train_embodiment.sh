...
#SBATCH --nodes=1
#SBATCH --gres=gpu:1 
#SBATCH --job-name=dsrl_90_pi05_q_chk_train
...
bash examples/embodiment/run_embodiment.sh libero_90_dsrl_openpi_pi05_q_chk #libero_90_dsrl_openpi #libero_90_noise_sac_openpi05 #maniskill_ppo_openpi_pi05 #libero_goal_ppo_openpi_pi05_resume