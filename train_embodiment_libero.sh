...
#SBATCH --nodes=1
#SBATCH --gres=gpu:1 
#SBATCH --error=/pfs/work9/workspace/scratch/ka_eu3660-rlinf_tmp/slurm-%j.err
#SBATCH --job-name=libero_object_dsrl_openpi
...
export NUM_CPUS=$(( SLURM_JOB_CPUS_PER_NODE * 95 / 100 )) # to leave 5% for other processes
printf "NUM_CPUS: %s\n" "$NUM_CPUS"
...
bash examples/embodiment/run_embodiment.sh libero_object_dsrl_openpi #libero_spatial_dsrl_openpi #libero_object_dsrl_openpi_pi05 #metaworld_50_dsrl_openpi_q_chk_consistency