...
#SBATCH --job-name=libero_10_task8_dsrl_openpi
...
bash examples/embodiment/run_embodiment.sh libero_10_dsrl_openpi #libero_object_dsrl_openpi_pi05 #metaworld_50_dsrl_openpi_q_chk_consistency