...
if [ "$RANK" -eq 0 ]; then
    ...
    ray start --head --memory=461708984320 --port=$RAY_PORT --dashboard-host $IP_ADDRESS
    ...
    ray start --memory=461708984320 --address="$HEAD_ADDRESS:$RAY_PORT" --dashboard-host $HEAD_ADDRESS
fi